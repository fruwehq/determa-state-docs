...
Markdown and run against Determa State 0.0.7 in both Python and Rust.
...
version 0.0.7 and from each author's machine `version`.
...
[states §4.6](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#46-state-nodes),
[transitions §4.7](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#47-transitions),
[hierarchical dispatch §6.3](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#63-hierarchical-dispatch),
[execution order §6.4](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#64-transition-execution-order),
[choice and history §6.5](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#65-choice-and-history),
and
[stop interruption §6.6](https://github.com/fruwehq/determa-state-spec/blob/v0.0.7/SPEC.md#66-stop-interruption).
